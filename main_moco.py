...
from ranczr_models import CustomModel
from dataset import TrainMoCoDataset
...
parser = argparse.ArgumentParser(description='PyTorch CheXprt pre-training Training')
parser.add_argument('data', metavar='DIR', help='path to dataset')
parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet50',
                    help=f'picked from timm (default: resnet50)')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = moco.builder.MoCo(args.arch, CustomModel,
    ...
    df = pd.read_csv(os.path.join(args.data,'Data_Entry_2017.csv'))
    ...
    # augmentation list
    augmentation = [
        transforms.RandomResizedCrop(512, 512, scale=(0.9, 1.0), p=1),
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (img_q, img_k) in enumerate(train_loader):
        # print(len(images))
