...
def train_loop(folds, fold):
    ...
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=int(CFG.T_max * 0.4), gamma=0.9)
...
if __name__ == "__main__":
    ...
    if not os.path.exists("./"):
        os.makedirs("./")
    LOGGER = init_logger(f"{CFG.model_name}-unet-fold{CFG.trn_fold[0]}.log")
